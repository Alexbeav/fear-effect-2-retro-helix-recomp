...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Fear Effect 2: Retro Helix",
    .project_root_env = "FEAR_EFFECT_2_RETRO_HELIX_PROJECT_ROOT",
    .build_dir_env = "FEAR_EFFECT_2_RETRO_HELIX_BUILD_DIR",
    .force_setup_env = "FEAR_EFFECT_2_RETRO_HELIX_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_012.66_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Fear_Effect_2_Retro_Helix",
    .prepare_note =
