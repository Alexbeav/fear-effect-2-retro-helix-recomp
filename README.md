...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/fear-effect-2-retro-helix-recomp/total)](https://github.com/Alexbeav/fear-effect-2-retro-helix-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/fear-effect-2-retro-helix-recomp/latest/total)](https://github.com/Alexbeav/fear-effect-2-retro-helix-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/fear-effect-2-retro-helix-recomp)](https://github.com/Alexbeav/fear-effect-2-retro-helix-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Fear Effect 2: Retro Helix** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-01266, SLUS-01275, SLUS-01276, SLUS-01277 4 disc images
...
|---|---|
| Region | USA |
| Disc serials | SLUS-01266, SLUS-01275, SLUS-01276, SLUS-01277 |
| Discs | 4 |
| Supported dump | Redump `Fear Effect 2 - Retro Helix (USA) (Disc 1) (Rev 1).cue`, `Fear Effect 2 - Retro Helix (USA) (Disc 2) (Rev 1).cue`, `Fear Effect 2 - Retro Helix (USA) (Disc 3) (Rev 1).cue`, `Fear Effect 2 - Retro Helix (USA) (Disc 4) (Rev 1).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/fear-effect-2-retro-helix-recomp/releases)
   and extract it into a writable folder.
2. Start `Fear_Effect_2_Retro_Helix` (`.exe` on Windows).
3. In the setup wizard select your 4 disc images (the Redump CUE, or a CHD of the
...
named `diagnostic-mode.txt` next to `Fear_Effect_2_Retro_Helix.exe` and start the game as
usual, or run `Fear_Effect_2_Retro_Helix.exe --diagnostic`. Reproduce the problem, quit, then
run `Fear_Effect_2_Retro_Helix.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
